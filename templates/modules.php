...
<div class="wrap oc-modules">
    <h1>
        <?php _e('Manage Modules', 'onyx-command'); ?>
    ...
    <?php else : ?>
        <table class="wp-list-table widefat fixed striped">
            <thead>
                <tr>
                    ...
                    <th><?php _e('Executions', 'onyx-command'); ?></th>
                    ...
                    <tr data-module-id="<?php echo esc_attr($module['module_id']); ?>">
                        ...
                        <td class="oc-actions">
                            ...
                            <button class="button button-small button-link-delete oc-delete-module" 
                                    data-module-id="<?php echo esc_attr($module['module_id']); ?>"
                                    title="<?php _e('Delete Module', 'onyx-command'); ?>">
        ...
        <div class="oc-bulk-actions">
            <select class="oc-bulk-action-select">
                <option value=""><?php _e('Bulk Actions', 'onyx-command'); ?></option>
                <option value="activate"><?php _e('Activate', 'onyx-command'); ?></option>
                <option value="deactivate"><?php _e('Deactivate', 'onyx-command'); ?></option>
                <option value="delete"><?php _e('Delete', 'onyx-command'); ?></option>
            </select>
            <button class="button oc-apply-bulk-action"><?php _e('Apply', 'onyx-command'); ?></button>
        </div>
    <?php endif; ?>
</div>

<!-- Module Scan Modal -->
<div id="oc-scan-modal" class="oc-modal" style="display: none;">
    <div class="oc-modal-content">
        <span class="oc-modal-close">&times;</span>
        <h2><?php _e('Module Scan Results', 'onyx-command'); ?></h2>
        <div id="oc-scan-results"></div>
    </div>
</div>

<!-- Module Configuration Modal -->
<div id="oc-config-modal" class="oc-modal" style="display: none;">
    <div class="oc-modal-content">
        <span class="oc-modal-close">&times;</span>
        <h2><?php _e('Module Configuration', 'onyx-command'); ?></h2>
        <div id="oc-config-form"></div>
    </div>
</div>

<!-- Statistics Modal -->
<div id="oc-stats-modal" class="oc-modal" style="display: none;">
    <div class="oc-modal-content">
        <span class="oc-modal-close">&times;</span>
        <h2><?php _e('Module Statistics', 'onyx-command'); ?></h2>
        <div id="oc-stats-content"></div>
    </div>
</div>
